...
def save_vocab_to_txt_file(vocab, txt_path):
    ...
    """
    with open(txt_path, "w", encoding='cp1252', errors='ignore') as f:
        for token in vocab:
            f.write(token + '\n')
...
def save_dict_to_json(d, json_path):
    ...
    """
    with open(json_path, 'w', encoding='cp1252', errors='ignore') as f:
...
def update_vocab(txt_path, vocab):
    ...
    """
    with open(txt_path, encoding='cp1252', errors='ignore') as f:
