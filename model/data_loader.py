...
class DataLoader(object):
    ...
    def __init__(self, data_dir, params):
        ...
        self.vocab = {}
        with open(vocab_path, encoding='cp1252', errors='ignore') as f:
        ...
        self.tag_map = {}
        with open(tags_path, encoding='cp1252', errors='ignore') as f:
    ...
    def load_sentences_labels(self, sentences_file, labels_file, d):
        ...
        with open(sentences_file, encoding='cp1252', errors='ignore') as f:
        ...
        with open(labels_file, encoding='cp1252', errors='ignore') as f:
            for sentence in f.read().splitlines():
